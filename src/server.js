...
import routerOrdentrabajo from './routers/ordentrabajo_routes.js'; // Importa el enrutador definido para las rutas relacionadas con ordenes
import routerProformas from './routers/proforma_routes.js'; // Importa el enrutador definido para las rutas relacionadas con proformas
...
app.use('/api', routerProformas); // Usa el enrutador de tratamientos en la ruta '/api'
